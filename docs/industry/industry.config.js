export default {
    'ecommerce': {
        ...
        banner: {
            subject: 'INDUSTRIES',
            type: ' eCommerce',
            desc: 'A Naturally integrated platforms and ERP solution',
            img: '/asset/eCommerceBanner.png'
        },
        trends: {
            title: 'Online selling made easy',
            text: 'Deliver unified and seamless commerce experiences across every touchpoint. Engage customers, drive revenue, and expand your reach across all channels - no matter if it is B2B or B2C.'
        },
        wehelp: {
    ...
    'manufacturing': {
        ...
        banner: {
            ...
            img: '/asset/header-Manufacturing.jpg'
        },
        trends: {
        ...
        wehelp: {
            ...
            items: [
                'Improved Transparency - Connecting IT systems from the top floor to the shop floor provides your managers with a clear view into all factory-wide processes.',
                'Better Collaboration - Digitally mapping processes across the entire value chain will reveal untapped synergies between your departments and functions.',
                'Greater Efficiency - Electronic worker guidance and paperless production enables the real-time data exchange and automation of business and production processes.'
            ],
            img: '/asset/img-manufacturing-tomorrow.jpg'
        },
        customer: {
            project: 'Smart Press',
