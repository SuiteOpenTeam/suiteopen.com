...
<div class="light-bg">
   <div class="layout-mid">
      ...
      <p class="tl-desc" style="width: 70%;">SuiteOpen is a leading implementer of NetSuite Solutions  and an Oracle Platinum Partner with over 10 years of NetSuite experience. Our Professional Services practice is home to a wealth of senior NetSuite consultants with industry specific and cross-functional expertise. </p>
   </div>
</div>
<div class="p-30">
   <div class="layout-mid">
